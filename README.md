...
To download the application follow the next steeps.
 ...
 4. Click on the most recent version and [_Download_](https://github.com/AlexOT03/Data-Base-Migration-Tool/blob/master/production/with_console/DataWise_Migration_Tool-v0.0.7C.zip) it
